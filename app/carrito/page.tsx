...
export default function CarritoPage() {
  ...
  useEffect(() => {
    ...
    if (saved) {
      try { setCart(JSON.parse(saved)); } catch { window.localStorage.removeItem("soltal-pet-cart"); }
    }
    setLoaded(true);
  }, []);
